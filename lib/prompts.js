...
export const SUMMARY_SCHEMA = {
  ...
  properties: {
    ...
    pattern: {
      type: "string",
      description: "2-3 sentences describing the recurring trigger/emotion/mood pattern observed.",
    },
    focus: {
      type: "string",
      description: "One small, specific thing to focus on next, tied to the pattern.",
    },
  },
